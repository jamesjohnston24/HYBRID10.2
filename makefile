...
HYBRID10.3.exe : $(OBJ)
	$(F90) $(FFLAGS) -o HYBRID10.3.exe $(OBJ) $(LDFLAGS)

# Main routine.
HYBRID10.3.o : Get_RSF.o get_clm.o advance.o Diag_Global.o double.o shared.o HYBRID10.3.f90
	$(F90) $(FFLAGS) -c HYBRID10.3.f90
