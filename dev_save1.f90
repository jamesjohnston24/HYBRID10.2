...
USE mpi
IMPLICIT NONE
INTEGER, PARAMETER :: ntasks = 32
INTEGER, PARAMETER :: nlon = 720, nlat = 360, ntimes = 1460, nland = 80000 ! nland = 67420
INTEGER, PARAMETER :: size = ntimes * nland / ntasks, root = 1, nyr = 10
INTEGER, PARAMETER :: nland_chunk = nland / ntasks, nplots = 50, nyr_spin = 120
  ...
  DO k = 1, nland_chunk
   ...
   DO kp = 1, nplots
    ...
    dSOM = BL - (2.0_DP ** ((tmp (t,kyr,k) - 273.15_DP) / 10.0_DP)) * SOM_plot (kp,k) * &
           (1.0_DP / (12.5_DP * 365.0_DP * 86400.0_DP))
